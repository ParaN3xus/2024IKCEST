...
train_seq_nums=[]
test_seq_nums = list(range(10))   # what ever you want
_SPLITS['debug_mot20_train']['test'] = {'seq': [f'SNMOT-{seq_num:03}' for seq_num in [5]], 'dir': 'train'}
_SPLITS['mot20_train']['test'] = {'seq': [f'SNMOT-{seq_num:03}' for seq_num in train_seq_nums], 'dir': 'train'}
_SPLITS['mot20_test']['test'] = {'seq': [f'SNMOT-{seq_num:03}' for seq_num in test_seq_nums], 'dir': 'test'}
