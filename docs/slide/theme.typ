...
#let focus-slide(background-color: none, background-img: none, body) = touying-slide-wrapper(self => {
  ...
  set text(fill: self.colors.neutral-lightest, weight: "bold", size: 2.67em)
...
#let my-university-theme(
  ...
  show: touying-slides.with(
    ...
    config-methods(
      init: (self: none, body) => {
        set text(fill: self.colors.neutral-darkest, size: 18.75pt)
